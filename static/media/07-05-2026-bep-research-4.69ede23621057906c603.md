...
From that point the architecture was simplified to a simple 3 layer CNN and a visual decoder on MNIST (since the previous work failed to stabilize on more complex Imagenet)
