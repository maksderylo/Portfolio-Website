...
import RoadmapBlog from './components/RoadmapBlog';
                        ...
                        <motion.div id='enter' >
                            <div id="page">
                                <div className="container" >
                                    {showParticles && (
                                        <div id='back'>
                                            <div id='buttoncont' onClick={handleClick}>
                                                <motion.h1
                    ...
                    <motion.div id='body2' >
                        <div className={colormode}>
                            ...
                            <Routes >
                                ...
                                <Route path="/roadmapblog" element={<RoadmapBlog setColorLight={setColorLight} />}/>
                            </Routes>
                            <Footer />
                        </div>
                    </motion.div>
